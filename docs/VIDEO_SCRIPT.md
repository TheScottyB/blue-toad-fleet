...
> **9 lots, $275.00 max, $316.25 all-in, 563 passing tests (570 collected)** — matching the absentee
...
* **Beat 4, replace the old result and test-count sentences:**
  > *"The final sheet commits $275 across nine approved bids—$316.25 all-in against $713 to $879 in estimated gross resale, a 2.25 to 2.78 times gross multiple before selling costs. The repository collects 570 tests; 563 pass locally and seven network checks skip by default."*
